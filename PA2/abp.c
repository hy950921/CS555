...
/* this is an event-driven simulation, each event has the following struc */
struct event {
...
/* ignore - need be completed only for extra credit */
...
/* ignore - called when B's timer goes off */
void B_timerinterrupt(void)
{
